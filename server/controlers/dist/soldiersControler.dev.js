...
exports.updateSoldiersCompanyInfo =
  exports.updateSoldierById =
  exports.addSoldier =
  exports.getSoldiersById =
  exports.getSoldiers =
  exports.getSoldiersByTrainingWeek =
    void 0;
...
var updateSoldiersCompanyInfo = function updateSoldiersCompanyInfo(req, res) {
  try {
    ...
    for (
      var _i = 0, _Object$entries = Object.entries(soldiers);
      ...
      for (
        var _i2 = 0, _Object$entries2 = Object.entries(soldierList);
