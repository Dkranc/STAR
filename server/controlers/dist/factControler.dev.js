...
exports.calcFinalFactGrade =
  exports.addFactGen =
  exports.addFactGenMed =
  exports.updateFact =
  exports.addFact =
  exports.getFactsByQuestionId =
  exports.getFactsByTestId =
  exports.getFactsByRolesId =
  exports.getFact =
    void 0;
...
var addFactGenMed = function addFactGenMed(req, res) {
  try {
    ...
    (function () {
      ...
      var selectSoldierQuery =
        "SELECT role,soldier_serial_id from soldier WHERE id=$1;";
      var selectQuestionJoinTestType =
        "SELECT * FROM test_type tt  INNER JOIN question q ON q.test_type_id = tt.id\n       WHERE q.name='\u05DE\u05E2\u05E8\u05D9\u05DD' AND tt.role_id=$1;";
      var sqlSelectFactIfExists =
      ...
      for (
        var _i = 0, _Object$entries = Object.entries(soldierAnswers);
  ...
  try {
    ...
    (function () {
      ...
      var _loop2 = function _loop2() {
        ...
        for (
          var _i3 = 0, _Object$entries3 = Object.entries(valQuestion);
      ...
      for (
        var _i2 = 0, _Object$entries2 = Object.entries(completedArray);
          ...
          try {
            ...
            _connectDB.db.query(
              ...
              function (err, result) {
                ...
                soldierArray.map(function (soldierId) {
                  soldiersFacts[soldierId] = result.rows.filter(function (
                    fact
                  ) {
                ...
                for (
                  var _i4 = 0, _Object$entries4 = Object.entries(soldiersFacts);
            ...
            _connectDB.db.query(
              ...
              function (err, result) {
                          ...
                          switch ((_context.prev = _context.next)) {
                            case 0:
                              ...
                              return regeneratorRuntime.awrap(
                                (0, _generatePdf.generatePdf)(soldier)
                              );

                            case 4:
                              succesSendingMail = _context.sent;
                              // send the pdf file and if faild add to failed list
                              if (!succesSendingMail)
                                errorWithSending.push(soldier);
                ...
                var getMP =
                  "SELECT * FROM soldier WHERE role=$1 AND week_number=$2;"; //TODO: add loop for all mp, and also add param from req for the week number.

                _connectDB.db.query(
                  getMP,
                  [5, training],
                  function _callee3(err, result) {
                    return regeneratorRuntime.async(function _callee3$(
                      _context3
                    ) {
                      while (1) {
                                      ...
                                      while (1) {
                                        switch (
                                          ...
                                          case 0:
                                            ...
                                            return regeneratorRuntime.awrap(
                                              (0,
                                              _generatePdf.generateCommanderPdf)(
                                                commander,
                                                result2.rows
                                              )
                                            );
                                          ...
                                          case 2:
                                            ...
                                            if (!succesSendingMail)
                                              errorWithSending.push(commander);
...
var calculateAndUpdate = function calculateAndUpdate(
  solId,
  solFacts,
  finalGradeObg
) {
  ...
  for (
    var _i5 = 0, _Object$entries5 = Object.entries(testFactObj);
                      ...
                      _connectDB.db.query(
                        ...
                        function _callee4(err, result) {
                          var weight,
                            ...
                            lastDay,
                            sqlUpdateTrans;
                          return regeneratorRuntime.async(function _callee4$(
                            _context5
                          ) {
                            while (1) {
                              switch ((_context5.prev = _context5.next)) {
                                case 0:
                                  ...
                                  if (weight != 0) {
                                    ...
                                    if (
                                      result.rows[0].input_type ===
                                      "open-numeric"
                                    ) {
                                      percent = fact.score / 100;
                                      finalGradeObg[solId] += weight * percent;
                                    } else if (
                                      result.rows[0].input_type === "numeric"
                                    ) {
