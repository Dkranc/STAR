  ...
  return(
    ...
    <AppBar position="static"  style={{ background: 'transparent', boxShadow: 'none'}}>
      ...
      >
        ...
        <Typography fontFamily={"ExtraBold"} align="center" color="#000000" variant="h6" component="div" sx={{ flexGrow: 1 }}>
          {pageName} 
        </Typography>
        <KeyboardBackspaceIcon style={{fill:"#000000"}} sx={{ flexGrow: 1 }} onClick={()=>navigate(-1)}/>      
        </Toolbar>
    </AppBar>
  </Box>
  );
